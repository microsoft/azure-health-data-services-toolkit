...
This sample shows you how you can send data to Azure Event Grid using a channel in the Azure Health Data Services SDK. This is useful for notifying other systems of data in your pipelines.
