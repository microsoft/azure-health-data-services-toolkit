...
namespace Microsoft.Fhir.Proxy.Tests.Assets
{
    public class FakeFunctionDefinition : FunctionDefinition
    {
        ...
        public FakeFunctionDefinition(string functionId = null, IDictionary<string, BindingMetadata> inputBindings = null, IDictionary<string, BindingMetadata> outputBindings = null, IEnumerable<FunctionParameter> parameters = null)
        {
        ...
        private static void DefaultEntryPoint()
        {
        }
    }
}
