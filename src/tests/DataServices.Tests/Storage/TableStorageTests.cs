...
namespace DataServices.Tests.Storage
{
    ...
    public class TableStorageTests
    {
        ...
        public async Task Table_InsertOrMergeEntityAsync()
        {
            ...
            string rowKey = "1";
            var entity = new TableEntity(partitionKey, rowKey);
            Azure.Response result = await storage.UpsertEntityAsync(tableName, entity);
        ...
        public async Task Table_MergeEntityAsync()
        {
            ...
            Azure.Response result2 = await storage.UpsertEntityAsync(tableName, entity);
        ...
        public async Task Table_DeleteEntityAsync()
        {
            ...
            _ = await storage.UpsertEntityAsync(tableName, entity);
            Azure.Response result = await storage.DeleteEntityAsync(tableName, entity);
