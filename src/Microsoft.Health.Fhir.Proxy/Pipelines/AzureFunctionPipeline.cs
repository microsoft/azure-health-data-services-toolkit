...
namespace Microsoft.Health.Fhir.Proxy.Pipelines
{
    ...
    public class AzureFunctionPipeline : IPipeline<HttpRequestData, HttpResponseData>
    {
        ...
        public AzureFunctionPipeline(IOptions<PipelineOptions> options, IInputFilterCollection inputFilters = null, IInputChannelCollection inputChannels = null, IBinding binding = null, IOutputFilterCollection outputFilters = null, IOutputChannelCollection outputChannels = null, TelemetryClient telemetryClient = null, ILogger<AzureFunctionPipeline> logger = null)
        {
